namespace NServiceBus.Routing
{
    ...
    public class UnicastRoutingTable
    {
        ...
        /// </summary>
        /// <remarks>For dynamic routes that do not require async use <see cref="AddExternalProvider(System.Func{System.Collections.Generic.List{System.Type},NServiceBus.Extensibility.ContextBag,System.Collections.Generic.IEnumerable{NServiceBus.Routing.IUnicastRoute}})"/>.</remarks>
        /// <param name="dynamicRule">The rule.</param>
        public void AddExternalProvider(Func<List<Type>, ContextBag, Task<IEnumerable<IUnicastRoute>>> dynamicRule)
        {
        ...
        /// Adds an external provider of routes.
        /// </summary>
        /// <remarks>For dynamic routes that require async use <see cref="AddExternalProvider(System.Func{System.Collections.Generic.List{System.Type},NServiceBus.Extensibility.ContextBag,System.Threading.Tasks.Task{System.Collections.Generic.IEnumerable{NServiceBus.Routing.IUnicastRoute}}})"/>.</remarks>
        /// <param name="dynamicRule">The rule.</param>
        public void AddExternalProvider(Func<List<Type>, ContextBag, IEnumerable<IUnicastRoute>> dynamicRule)
        {
